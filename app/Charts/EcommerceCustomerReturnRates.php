...
class EcommerceCustomerReturnRates extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        foreach($ecommerce as $value){
            ...
            array_push($customer_return_rates, $value->customer_return_rates);
        }
        ...
        if($request->comparisonBegin){
            ...
            foreach($ecommerceCompare as $value){
                ...
                array_push($compare, $value->customer_return_rates);
            }
        }
        
        return Chartisan::build()
            ->labels($dates)
            ->dataset('Taux Retour '.$label, $customer_return_rates)
            ->dataset('Taux Retour '.$labelCompare, $compare);
    }
}