...
class EcommerceConversionRates extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        foreach($ecommerce as $value){
            ...
            array_push($conversions_rates, $value->conversions_rates);
        }
        ...
        if($request->comparisonBegin){
            ...
            foreach($ecommerceCompare as $value){
                ...
                array_push($compare, $value->conversions_rates);
            }
        }
        
        return Chartisan::build()
            ->labels($dates)
            ->dataset('Taux Conversion '.$label, $conversions_rates)
            ->dataset('Taux Conversion '.$labelCompare, $compare);
    }
}