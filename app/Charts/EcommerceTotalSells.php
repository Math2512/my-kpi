...
class EcommerceTotalSells extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        foreach($ecommerce as $value){
            ...
            array_push($total_sells, $value->total_sells);
        }
        ...
        if($request->comparisonBegin){
            ...
            foreach($ecommerceCompare as $value){
                ...
                array_push($compare, $value->total_sells);
            }
        }
        
        return Chartisan::build()
            ->labels($dates)
            ->dataset('Ventes totales '.$label, $total_sells)
            ->dataset('Ventes totales '.$labelCompare, $compare);
    }
}