...
class InstaSubscriptionsChart extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        foreach($instas as $value){
            ...
            array_push($subscriptions, $value->subscription);
        }
        ...
        if($request->comparisonBegin){
            ...
            foreach($instasCompare as $value){
                ...
                array_push($compare, $value->subscription);
            }
        }

        return Chartisan::build()
            ->labels($dates)
            ->dataset('Abonnements suite à une publication '.$label, $subscriptions)
            ->dataset('Abonnements suite à une publication '.$labelCompare, $compare);
    }
}