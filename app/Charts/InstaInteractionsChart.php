...
class InstaInteractionsChart extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        foreach($instas as $value){
            ...
            array_push($interations, $value->interactions);
        }
        ...
        if($request->comparisonBegin){
            ...
            foreach($instasCompare as $value){
                ...
                array_push($compare, $value->interactions);
            }
        }

        return Chartisan::build()
            ->labels($dates)
            ->dataset('Nombre interactions '.$label, $interations)
            ->dataset('Nombre interactions '.$labelCompare, $compare);
    }
}